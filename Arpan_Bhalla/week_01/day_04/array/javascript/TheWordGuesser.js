...
// guess the word (like Hangman without
...
//  and one to hold the current guessed letters (e.g. it would start with '', '', '_' and
//  end with 'F', 'O', 'X').
...
// once. If they guess a letter twice, do nothing.
